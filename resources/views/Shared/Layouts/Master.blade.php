...
<head>
   ...
   <!--/Meta-->
    ...
    <!--JS-->
    {!! HTML::script(config('atte.cdn_url_static_assets').'/vendor/jquery/jquery.min.js') !!}
    <!--/JS-->

    <!--Style-->
    {!! HTML::style(config('atte.cdn_url_static_assets').'/assets/stylesheet/application.css') !!}
    <!--/Style-->
        ...
        <ul class="nav navbar-nav navbar-right">
            <li class="dropdown profile">
                ...
                <ul class="dropdown-menu" role="menu">
                    ...
                    <li class="divider"></li>
                    <li><a target="_blank" href="https://www.attendize.com/feedback.php?v={{ config('atte.version') }}"><span class="icon ico-megaphone"></span>Feedback / Bug Report</a></li>
                    <li class="divider"></li>
