...
class EventCustomizeController extends MyBaseController
{
    ...
    {
//        $data = json_decode(get_game_data(14792091819),true);
//        var_dump($data['data']['result'][0]['game_name']);exit;
    ...
    public function getAvailableBackgroundImages()
    {
        ...
        $files = File::files(public_path() . '/' . config('atte.event_bg_images'));
    ...
    public function getAvailableBackgroundImagesThumbs()
    {
        ...
        $files = File::files(public_path() . '/' . config('atte.event_bg_images') . '/thumbs');
